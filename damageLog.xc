...

{
  "damageLog": {
    ...
    "log": {
      ...
      "formatHistory": "<textformat tabstops='[30,70]'><font face='mono' size='12'>{{number%3d~.}}</font><tab><font color='#CCCCCC'>{{hit-effects}}{{critical-hit}}{{splash-hit}}<tab>{{dmg-kind}}</font></textformat>"
    },
    // TODO.
