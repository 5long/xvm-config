 ...
 */
{
  ...
  "def": {
    ...
    "hpBarBg": { "hotKeyCode": 29, "onHold": "true", "visibleOnHotKey": true, "x": 21, "y": 6, "width": 72, "bindToIcon": true, "height": 14, "bgColor": "0x000000", "alpha": "{{alive?35|0}}" },
    // HP bar.
    // Индикатор HP.
    "hpBar": { "hotKeyCode": 29, "onHold": "true", "visibleOnHotKey": true, "x": 22, "y": 7, "bindToIcon": true, "width": "{{hp-ratio:70}}", "height": 12, "bgColor": "{{player?#FFDD33|{{c:system}}}}", "alpha": "{{alive?50|0}}" },
    // Remaining HP.
    // Оставшиеся HP.
    "hp": { "hotKeyCode": 29, "onHold": "true", "visibleOnHotKey": true, "x": 57, "y": 4, "bindToIcon": true, "align": "center", "alpha": "{{alive?100|0}}",
