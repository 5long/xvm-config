 ...
 */
{
  "circles": {
    ...
    "view": [
      ...
      { "enabled":  true, "distance": 350, "scale": 1, "thickness": 0.7, "alpha": 80, "color": "0x9ECCEE" },
      { "enabled":  true, "distance": 445, "scale": 1, "thickness": 0.7, "alpha": 40, "color": "0x9ECCEE" },
      // Circle of the maximum units appearance.
      // Окружность границы максимальной отрисовки юнитов.
      { "enabled": true, "distance": 564, "scale": 1, "thickness": 0.7, "alpha": 40, "color": "0x9ECCEE" },
      // Additional circles:
      // Дополнительные круги:
      { "enabled": true, "distance": 50,           "scale": 1, "thickness": 0.7, "alpha": 60, "color": "0x9ECCEE" },
